...
const songs = [
    ...
    { title: "Spirit in the Sky", artist: "Norman Greenbaum", genre: "Rock", url:"https://youtu.be/W2msh0jut2Y?si=LsJaU-yWFz-KZh_q" },
    { title: "Cherry Bomb", artist: "The Runaways", genre: "Rock" , url:"https://youtu.be/K2ws6vMFF3c?si=vsLBhVPhBL_T4AE2"},
    { title: "Escape (The Piña Colada Song)", artist: "Rupert Holmes", genre: "Pop" , url:"https://youtu.be/FXG_I_tf_i4?si=dFaogbQ3UugvoL57"},
...
function generatePlaylist(guardians, songs) {
    ...
    Object.keys(guardians).forEach(guardian => {
        ...
        playlist.forEach(song => {
            ...
            listItem.innerHTML = `<a class="song-link" href="${song.url}" target="_blank">
